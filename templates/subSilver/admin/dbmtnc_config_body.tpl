...
<form action="{S_CONFIG_ACTION}" method="post"><table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		<td class="row1">
			<label for="disallow_postcounter">{L_DISALLOW_POSTCOUNTER}</label>
			<br />
...
<!-- BEGIN rebuild_settings -->
	...
	<tr>
		...
		<td class="row2"><input class="post" type="text" maxlength="5" size="5" name="rebuildcfg_timelimit" id="rebuildcfg_timelimit" value="{REBUILDCFG_TIMELIMIT}" /></td>
	</tr>
	<tr>
		<td class="row1">
		...
		<td class="row2"><input class="post" type="text" maxlength="5" size="5" name="rebuildcfg_timeoverwrite" id="rebuildcfg_timeoverwrite" value="{REBUILDCFG_TIMEOVERWRITE}" /></td>
	</tr>
	<tr>
		<td class="row1">
		...
		<td class="row2"><input class="post" type="text" maxlength="5" size="5" name="rebuildcfg_maxmemory" id="rebuildcfg_maxmemory" value="{REBUILDCFG_MAXMEMORY}" /></td>
	</tr>
	<tr>
		<td class="row1">
		...
		<td class="row2"><input class="post" type="text" maxlength="3" size="3" name="rebuildcfg_minposts" id="rebuildcfg_minposts" value="{REBUILDCFG_MINPOSTS}" /></td>
	</tr>
	<tr>
		<td class="row1">
		...
		<td class="row2"><input type="radio" name="rebuildcfg_php3only" id="rebuildcfg_php3only" value="1" {REBUILDCFG_PHP3ONLY_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="rebuildcfg_php3only" value="0" {REBUILDCFG_PHP3ONLY_NO} /> {L_NO}</td>
	</tr>
	<tr>
		<td class="row1">
		...
		<td class="row2"><input class="post" type="text" maxlength="3" size="3" name="rebuildcfg_php4pps" id="rebuildcfg_php4pps" value="{REBUILDCFG_PHP4PPS}" /></td>
	</tr>
	<tr>
		<td class="row1">
...
<!-- BEGIN currentrebuild_settings -->
	...
	<tr>
		...
		<td class="row2"><input class="post" type="text" maxlength="10" size="8" name="rebuild_pos" id="rebuild_pos" value="{REBUILD_POS}" /></td>
	</tr>
	<tr>
		<td class="row1">
		...
		<td class="row2"><input class="post" type="text" maxlength="10" size="8" name="rebuild_end" id="rebuild_end" value="{REBUILD_END}" /></td>
	</tr>
