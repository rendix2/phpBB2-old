...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
    ...
    <tr>
        ...
        <td width="20%" class="{reg_user_row.ROW_CLASS}">&nbsp;<span class="gen">{reg_user_row.IP_ADDRESS}</span>&nbsp;</td>
    </tr>
    <!-- END reg_user_row -->
    <tr>
    ...
    <tr>
        ...
        <td width="20%" class="{guest_user_row.ROW_CLASS}">&nbsp;<span class="gen">{guest_user_row.IP_ADDRESS}</span>&nbsp;</td>
    </tr>
    <!-- END guest_user_row -->
</table>