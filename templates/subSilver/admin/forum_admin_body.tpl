...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
	...
	<tr>
		...
		<td class="cat" align="center" valign="middle"><span class="gen">{catrow.L_THANKS}</span></td>
	...
	<tr> 
		...
		<td class="row2" align="center" valign="middle"><span class="gen">{catrow.forumrow.NUM_THANKS}</span></td>
