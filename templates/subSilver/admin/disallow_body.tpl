...
<form method="post" action="{S_FORM_ACTION}"><table width="80%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr> 
		<td class="row1">
			<label for="disallowed_user">{L_USERNAME}</label>
			<br />
			<span class="gensmall">{L_ADD_EXPLAIN}</span>
		</td>
		<td class="row2"><input class="post" type="text" name="disallowed_user" id="disallowed_user" size="30" />&nbsp;<input type="submit" name="add_name" value="{L_ADD}" class="mainoption" /></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td class="row1">
			...
			<br />
			<span class="gensmall">{L_DELETE_EXPLAIN}</span>
		</td>
