  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  <td class="row1" nowrap="nowrap">
		  <label for="subject">
		  	<span class="gen">{L_SPLIT_SUBJECT}</span>
		  </label>
	  </td>
	  <td class="row2" colspan="2"><input class="post" type="text" size="35" style="width: 350px" maxlength="60" name="subject" id="subject" /></td>
	</tr>
	<tr> 
