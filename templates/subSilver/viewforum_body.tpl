...
<form method="post" action="{S_POST_DAYS_ACTION}">
  ...
  <table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	<tr> 
	  ...
	  <th width="50" align="center" class="thTop" nowrap="nowrap">&nbsp;{L_THANKS}&nbsp;</th>
	...
	<tr> 
	  ...
	  <td class="row1" width="100%">
		  <span class="topictitle">
			  {topicrow.NEWEST_POST_IMG}{topicrow.TOPIC_ATTACHMENT_IMG}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a>
		  </span>
	  ...
	  <td class="row2" align="center" valign="middle">
		  <span class="postdetails">{topicrow.THANKS}</span>
	  </td>
	  <td class="row2" align="center" valign="middle">
		  <span class="postdetails">{topicrow.VIEWS}</span>
	  </td>
	  <td class="row3Right" align="center" valign="middle" nowrap="nowrap">
		  <span class="postdetails">{topicrow.LAST_POST_TIME}<br />{topicrow.LAST_POST_AUTHOR} {topicrow.LAST_POST_IMG}</span>
	  </td>
	</tr>
	<!-- END topicrow -->
