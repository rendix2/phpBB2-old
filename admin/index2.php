...
if (isset($_GET['pane']) && $_GET['pane'] === 'left') {
    ...
    $template->assignVars(
        [
            'U_FORUM_INDEX' => Session::appendSid('../index2.php'),
            'U_ADMIN_INDEX' => Session::appendSid('index2.php?pane=right'),
    ...
    $template->assignVars(
        [
            'S_FRAME_NAV'  => Session::appendSid('index2.php?pane=left'),
            'S_FRAME_MAIN' => Session::appendSid('index2.php?pane=right')
        ]
    );
