 ...
 *
 *   $Id: page_header_admin.php 5509 2006-01-29 21:19:02Z grahamje $
 *
 *
 ***************************************************************************/
...
if ($board_config['gzip_compress']) {
	...
	if ($phpver >= '4.0.4pl1' && (false !== mb_strpos($useragent, 'compatible') || false !== mb_strpos($useragent, 'Gecko'))) {
...
$template->assignVars(
	[
		...
		'S_JUMPBOX_ACTION'    => Session::appendSid('../viewforum.php'),
