...
switch ($mode) {
	...
	case 'move':
        ...
        if ($confirm) {
			...
			$message .= sprintf($lang['Click_return_forum'], '<a href="' . 'viewforum.php?' . POST_FORUM_URL . "=$old_forum_id&amp;sid=" . $userdata['session_id'] . '">', '</a>') . '<br \><br \>';
	...
	case 'lock':
		...
		$message .= sprintf($lang['Click_return_forum'], '<a href="' . 'viewforum.php?' . POST_FORUM_URL . "=$forum_id&amp;sid=" . $userdata['session_id'] . '">', '</a>') . '<br \><br \>';
