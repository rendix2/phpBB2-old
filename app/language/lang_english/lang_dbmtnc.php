...
// reset_date
$lang['Resetting_future_post_dates'] = 'Resetting entries in the future';
...
$lang['Option_Help_Text'] = '<p>If you get reported that there was an error creating a session or so, you can clear the session data by
	...
	<b>Repair database tables</b>. <b>Check config table</b> will check the config table for missing entries, which may
