...
if ($mode === 'searchuser') {
    ...
    if ($search_id === 'newposts' || $search_id === 'egosearch' || $search_id === 'unanswered' || $search_keywords !== '' || $search_author !== '') {
		...
		$auth_sql = '';
        if ($search_forum !== -1) {
            $is_auth = Auth::authorize(Auth::AUTH_READ, $search_forum, $userdata);
            ...
            $is_auth = Auth::authorize(Auth::AUTH_READ, Auth::AUTH_ALL, $userdata);
            ...
            if ($show_results === 'posts') {
                ...
                $template->assignBlockVars('searchresults',
                    [
                        ...
                        'TOPIC_THANKS'  => $search_set->topic_thanks,
                ...
                $template->assignBlockVars('searchresults',
                    [
                        ...
                        'GOTO_PAGE'        => $goto_page,
                        'REPLIES'          => $replies,
                        'THANKS'           => $search_set->topic_thanks,
                        'TOPIC_TITLE'      => $topic_title,
